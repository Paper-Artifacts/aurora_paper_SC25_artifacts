...
qsub -l select=1    -l walltime=05:00:00 -l filesystems=flare -q prod           oneccl-2021.14.submit 
qsub -l select=2    -l walltime=05:00:00 -l filesystems=flare -q prod           oneccl-2021.14.submit 
qsub -l select=4    -l walltime=05:00:00 -l filesystems=flare -q prod           oneccl-2021.14.submit 
qsub -l select=8    -l walltime=05:00:00 -l filesystems=flare -q prod           oneccl-2021.14.submit 
qsub -l select=16   -l walltime=05:00:00 -l filesystems=flare -q prod           oneccl-2021.14.submit 
qsub -l select=32   -l walltime=05:00:00 -l filesystems=flare -q prod           oneccl-2021.14.submit 
